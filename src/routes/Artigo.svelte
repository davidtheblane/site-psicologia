...
<div class="flex flex-col px-4 items-center">
  ...
  <p class="p-4 text-lg text-wrap text-gray-400 text-justify">
    ...
    ferramenta para autoconhecimento, e conhecer a si mesma é um pilar essencial
  ...
  <p class="p-4 text-lg text-wrap text-gray-400 text-justify">
    ...
    problemas de saúde inexplicáveis como, dor de cabeça ou no estômago.
    Estresse constante, experiência de trauma ou perda, problemas de
    relacionamento, dificuldades emocionais, ou se busca entender melhor a si
    mesma. Todos esses podem ser sinais de que está na hora de começar a
    terapia.
  </p>
  ...
  <p class="p-4 text-lg text-wrap text-gray-400 text-justify">
    ...
    sinal importante de que você está priorizando a sua saúde mental.
  </p>
