<section class="text-gray-600 body-font">
  ...
  <div class="container px-5 py-24 mx-auto flex flex-wrap">
    ...
    <div class="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto">
      ...
      <div
        class="flex-shrink-0 w-6 h-6 rounded-full mt-10 sm:mt-0 inline-flex items-center justify-center bg-pink-400 text-white relative z-10 title-font font-medium text-sm"
      >
        1
      </div>
      <div
      ...
      >
        ...
        <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
          ...
          <p class="leading-relaxed">
            ...
            se beneficiar da conveniência de ter um acompanhamento
            psicoterapêutico sem sair de casa.
          </p>
        </div>
      </div>
    </div>
      ...
      >
        ...
        <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
          ...
          <p class="leading-relaxed">
            ...
            fazer o acompanhamento com um profissional da sua cidade.
          </p>
        </div>
      </div>
    </div>
